...
<template>
  <transition name="fade">
    <div
      ...
      class="fixed inset-0 bg-slate-900/40 flex items-center justify-center z-40"
    >
      <div
        class="bg-slate-950 backdrop-blur-md backdrop-filter p-6 rounded-lg shadow-lg w-full max-w-md relative top-modal"
      >
