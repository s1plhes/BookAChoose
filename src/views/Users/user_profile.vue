...
<template>
  ...
  <div id="user-profile" class="min-h-screen text-white">
    <div class="container mx-auto">
      ...
      <!--  H E A D E R  -->
      <div
        v-if="profileUser.header_image"
        class="bg-yellow-500 text-center w-full p-6 h-[350px]"
        :style="`background:url(${profileUser.header_image || 'default-cover.png'});
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div class="p-4 bg-glass">
            ...
            <div>
              <div
                ...
                :key="book.id"
                class="grid grid-cols-3 bg-slate-950 p-4 my-4 relative"
              >
        ...
        <div class="p-4 col-span-2">
          ...
          <div v-else>
            <RouterLink class="text-yellow-500 text-center mx-auto" to="/login"
